Attribute VB_Name = "DAOSubcontactos"
     Option Explicit
...
'
'
'Public Function FindByContactoPpal(idContactoPpal As Long) As Collection
'    Set FindByContactoPpal = FindAll("id_agenda= " & idContactoPpal)
'End Function
'
'
...
'    q = "SELECT * FROM datos_agenda da " _
'    & " LEFT JOIN agenda a ON da.id_agenda = a.id WHERE 1=1 "
'
...
'    While Not rs.EOF
'
'        Set C = DAOFacturaDetalles.Map(rs, indice, "AdminFacturasDetalleNueva", "entregas")
