...
Begin VB.Form frmArchivos 
   ...
   Begin GridEX20.GridEX grid 
      ...
      IntProp7        =   0
      ColumnsCount    =   5
      Column(1)       =   "frmArchivos.frx":0000
      Column(2)       =   "frmArchivos.frx":0114
      Column(3)       =   "frmArchivos.frx":026C
      Column(4)       =   "frmArchivos.frx":033C
      Column(5)       =   "frmArchivos.frx":0430
      FormatStylesCount=   6
      FormatStyle(1)  =   "frmArchivos.frx":050C
      FormatStyle(2)  =   "frmArchivos.frx":0644
      FormatStyle(3)  =   "frmArchivos.frx":06F4
      FormatStyle(4)  =   "frmArchivos.frx":07A8
      FormatStyle(5)  =   "frmArchivos.frx":0880
      FormatStyle(6)  =   "frmArchivos.frx":0938
      ImageCount      =   0
      PrinterProperties=   "frmArchivos.frx":0A18
   End
   ...
   Begin XtremeSuiteControls.GroupBox GroupBox2 
      ...
      Begin GridEX20.GridEX gridBuscador 
         ...
         BackColorHeader =   16761024
         ImageCount      =   1
         ImagePicture1   =   "frmArchivos.frx":0BF0
         ItemCount       =   1
         DataMode        =   99
         ColumnHeaderHeight=   285
         IntProp1        =   0
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmArchivos.frx":0DCA
         Column(2)       =   "frmArchivos.frx":0F02
         FormatStylesCount=   6
         FormatStyle(1)  =   "frmArchivos.frx":105A
         FormatStyle(2)  =   "frmArchivos.frx":1192
         FormatStyle(3)  =   "frmArchivos.frx":1242
         FormatStyle(4)  =   "frmArchivos.frx":12F6
         FormatStyle(5)  =   "frmArchivos.frx":13CE
         FormatStyle(6)  =   "frmArchivos.frx":1486
         ImageCount      =   1
         ImagePicture(1) =   "frmArchivos.frx":1566
         PrinterProperties=   "frmArchivos.frx":1740
      End
