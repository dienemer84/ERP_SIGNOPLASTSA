...
Begin VB.Form frmSeguimientoEspecialPorRuta 
   ...
   ClientTop       =   435
   ClientWidth     =   14955
   Icon            =   "frmSeguimientoEspecialPorRuta.frx":0000
   LinkMode        =   1  'Source
   LinkTopic       =   "df"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin GridEX20.GridEX gridProcesos 
      ...
      IntProp7        =   0
      ColumnsCount    =   2
      Column(1)       =   "frmSeguimientoEspecialPorRuta.frx":000C
      Column(2)       =   "frmSeguimientoEspecialPorRuta.frx":0138
      FormatStylesCount=   6
      FormatStyle(1)  =   "frmSeguimientoEspecialPorRuta.frx":022C
      FormatStyle(2)  =   "frmSeguimientoEspecialPorRuta.frx":0364
      FormatStyle(3)  =   "frmSeguimientoEspecialPorRuta.frx":0414
      FormatStyle(4)  =   "frmSeguimientoEspecialPorRuta.frx":04C8
      FormatStyle(5)  =   "frmSeguimientoEspecialPorRuta.frx":05A0
      FormatStyle(6)  =   "frmSeguimientoEspecialPorRuta.frx":0658
      ImageCount      =   0
      PrinterProperties=   "frmSeguimientoEspecialPorRuta.frx":0738
   End
   ...
   End
End
Attribute VB_Name = "frmSeguimientoEspecialPorRuta"
...
Private DetalleOtConjunto As DetalleOTConjuntoDTO
            ...
            If LenB(scannerBuffer) > 0 Then
                ...
                Else
                    If IsSomething(Empleado) Then
                        ...
                        GetDetalleOT
                    Else
                        ShowMessage "Debe ingresar un legajo antes de una ruta"
                    End If
                End If
            Else
                LimpiarData
...
Private Sub GetDetalleOT()
    ...
    If Not fromEmpleado Then
        ...
        If Not IsSomething(DetalleOt) Then    'sera conjunto?
            Set DetalleOtConjunto = DAODetalleOrdenTrabajo.FindConjuntoById(tmpId)
        End If
...
Private Sub IniciarProceso()
    If DAOEmpleados.GetTareasIdAsignadasByPersonalId(Empleado.Id).Exists(proceso.Tarea.Id) Then
        ...
        If mismaTarea Then
            Set tiempoProcesoDet = New PlaneamientoTiempoProcesoDetalle
            ...
            If DAOTiemposProcesosDetalles.Save(tiempoProcesoDet) Then
                Me.gridProcesos.ItemCount = 0
                ShowMessage "La tarea [" & proceso.Tarea.Description & "] ha sido iniciada"
                ClearEmpleadoProcesoObject
            Else
