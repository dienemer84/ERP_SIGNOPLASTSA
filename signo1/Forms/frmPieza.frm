...
Begin VB.Form frmPieza 
   ...
   Begin XtremeSuiteControls.GroupBox GroupBox1 
      ...
      Begin XtremeSuiteControls.ComboBox ComboBox 
         Height          =   315
         Left            =   1440
         TabIndex        =   39
         Top             =   645
...
Private Sub Form_Load()
    Customize Me
    Me.ComboBox.text = DAOCliente.FindAll(DAOCliente.TABLA_CLIENTE & "." & DAOCliente.CAMPO_ESTADO & "=" & EstadoCliente.activo & " ORDER BY " & DAOCliente.CAMPO_RAZON_SOCIAL)
