...
Begin VB.Form frmAdminPagosPagoACtaLista 
   ...
   Begin GridEX20.GridEX gridOrdenes 
      ...
      Column(2)       =   "frmAdminPagosPagoACtaLista.frx":01A8
      Column(3)       =   "frmAdminPagosPagoACtaLista.frx":02D0
      Column(4)       =   "frmAdminPagosPagoACtaLista.frx":0430
      Column(5)       =   "frmAdminPagosPagoACtaLista.frx":0578
      Column(6)       =   "frmAdminPagosPagoACtaLista.frx":06B8
      Column(7)       =   "frmAdminPagosPagoACtaLista.frx":0800
      Column(8)       =   "frmAdminPagosPagoACtaLista.frx":0958
      FormatStylesCount=   11
      FormatStyle(1)  =   "frmAdminPagosPagoACtaLista.frx":0AA0
      FormatStyle(2)  =   "frmAdminPagosPagoACtaLista.frx":0BC8
      FormatStyle(3)  =   "frmAdminPagosPagoACtaLista.frx":0C78
      FormatStyle(4)  =   "frmAdminPagosPagoACtaLista.frx":0D2C
      FormatStyle(5)  =   "frmAdminPagosPagoACtaLista.frx":0E04
      FormatStyle(6)  =   "frmAdminPagosPagoACtaLista.frx":0EBC
      FormatStyle(7)  =   "frmAdminPagosPagoACtaLista.frx":0F9C
      FormatStyle(8)  =   "frmAdminPagosPagoACtaLista.frx":0FBC
      FormatStyle(9)  =   "frmAdminPagosPagoACtaLista.frx":1070
      FormatStyle(10) =   "frmAdminPagosPagoACtaLista.frx":1128
      FormatStyle(11) =   "frmAdminPagosPagoACtaLista.frx":11DC
      ImageCount      =   0
      PrinterProperties=   "frmAdminPagosPagoACtaLista.frx":1298
   End
