...
Begin VB.Form frmAdminPagosPagoACtaLista 
   ...
   Begin GridEX20.GridEX gridOrdenes 
      ...
      Column(4)       =   "frmAdminPagosPagoACtaLista.frx":0410
      Column(5)       =   "frmAdminPagosPagoACtaLista.frx":0558
      Column(6)       =   "frmAdminPagosPagoACtaLista.frx":0698
      Column(7)       =   "frmAdminPagosPagoACtaLista.frx":07E0
      Column(8)       =   "frmAdminPagosPagoACtaLista.frx":0938
      FormatStylesCount=   11
      FormatStyle(1)  =   "frmAdminPagosPagoACtaLista.frx":0A80
      FormatStyle(2)  =   "frmAdminPagosPagoACtaLista.frx":0BA8
      FormatStyle(3)  =   "frmAdminPagosPagoACtaLista.frx":0C58
      FormatStyle(4)  =   "frmAdminPagosPagoACtaLista.frx":0D0C
      FormatStyle(5)  =   "frmAdminPagosPagoACtaLista.frx":0DE4
      FormatStyle(6)  =   "frmAdminPagosPagoACtaLista.frx":0E9C
      FormatStyle(7)  =   "frmAdminPagosPagoACtaLista.frx":0F7C
      FormatStyle(8)  =   "frmAdminPagosPagoACtaLista.frx":0F9C
      FormatStyle(9)  =   "frmAdminPagosPagoACtaLista.frx":1050
      FormatStyle(10) =   "frmAdminPagosPagoACtaLista.frx":1108
      FormatStyle(11) =   "frmAdminPagosPagoACtaLista.frx":11BC
      ImageCount      =   0
      PrinterProperties=   "frmAdminPagosPagoACtaLista.frx":1278
   End
