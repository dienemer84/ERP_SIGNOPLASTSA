...
Begin VB.Form frmResumenBancario 
   ...
   Begin GridEX20.GridEX gridResumenBancario 
      ...
      Column(2)       =   "frmResumenBancario.frx":013C
      Column(3)       =   "frmResumenBancario.frx":0254
      Column(4)       =   "frmResumenBancario.frx":0394
      Column(5)       =   "frmResumenBancario.frx":04B4
      Column(6)       =   "frmResumenBancario.frx":05FC
      Column(7)       =   "frmResumenBancario.frx":0754
      Column(8)       =   "frmResumenBancario.frx":089C
      Column(9)       =   "frmResumenBancario.frx":0A1C
      FormatStylesCount=   6
      FormatStyle(1)  =   "frmResumenBancario.frx":0B8C
      FormatStyle(2)  =   "frmResumenBancario.frx":0CC4
      FormatStyle(3)  =   "frmResumenBancario.frx":0D74
      FormatStyle(4)  =   "frmResumenBancario.frx":0E28
      FormatStyle(5)  =   "frmResumenBancario.frx":0F00
      FormatStyle(6)  =   "frmResumenBancario.frx":0FB8
      ImageCount      =   0
      PrinterProperties=   "frmResumenBancario.frx":1098
   End
