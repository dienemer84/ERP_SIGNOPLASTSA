...
Begin VB.Form frmAdminComprasListaFCProveedor 
   ...
   ClientTop       =   4725
   ClientWidth     =   20370
   Icon            =   "frmAdminComprasListaFCProveedor_back.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   4000
   ScaleMode       =   0  'User
   ...
   Begin GridEX20.GridEX grilla 
      ...
      ImageCount      =   1
      ImagePicture1   =   "frmAdminComprasListaFCProveedor_back.frx":000C
      DataMode        =   99
      ...
      IntProp7        =   0
      ColumnsCount    =   20
      Column(1)       =   "frmAdminComprasListaFCProveedor_back.frx":0326
      Column(2)       =   "frmAdminComprasListaFCProveedor_back.frx":045E
      Column(3)       =   "frmAdminComprasListaFCProveedor_back.frx":0586
      Column(4)       =   "frmAdminComprasListaFCProveedor_back.frx":06A6
      Column(5)       =   "frmAdminComprasListaFCProveedor_back.frx":07EA
      Column(6)       =   "frmAdminComprasListaFCProveedor_back.frx":096A
      Column(7)       =   "frmAdminComprasListaFCProveedor_back.frx":0AAE
      Column(8)       =   "frmAdminComprasListaFCProveedor_back.frx":0D1A
      Column(9)       =   "frmAdminComprasListaFCProveedor_back.frx":0F16
      Column(10)      =   "frmAdminComprasListaFCProveedor_back.frx":1146
      Column(11)      =   "frmAdminComprasListaFCProveedor_back.frx":1336
      Column(12)      =   "frmAdminComprasListaFCProveedor_back.frx":1542
      Column(13)      =   "frmAdminComprasListaFCProveedor_back.frx":1742
      Column(14)      =   "frmAdminComprasListaFCProveedor_back.frx":18B2
      Column(15)      =   "frmAdminComprasListaFCProveedor_back.frx":1A1A
      Column(16)      =   "frmAdminComprasListaFCProveedor_back.frx":1B72
      Column(17)      =   "frmAdminComprasListaFCProveedor_back.frx":1CDE
      Column(18)      =   "frmAdminComprasListaFCProveedor_back.frx":1E36
      Column(19)      =   "frmAdminComprasListaFCProveedor_back.frx":1FDA
      Column(20)      =   "frmAdminComprasListaFCProveedor_back.frx":2132
      FormatStylesCount=   9
      FormatStyle(1)  =   "frmAdminComprasListaFCProveedor_back.frx":2232
      FormatStyle(2)  =   "frmAdminComprasListaFCProveedor_back.frx":236A
      FormatStyle(3)  =   "frmAdminComprasListaFCProveedor_back.frx":241A
      FormatStyle(4)  =   "frmAdminComprasListaFCProveedor_back.frx":24CE
      FormatStyle(5)  =   "frmAdminComprasListaFCProveedor_back.frx":25A6
      FormatStyle(6)  =   "frmAdminComprasListaFCProveedor_back.frx":265E
      FormatStyle(7)  =   "frmAdminComprasListaFCProveedor_back.frx":273E
      FormatStyle(8)  =   "frmAdminComprasListaFCProveedor_back.frx":27FE
      FormatStyle(9)  =   "frmAdminComprasListaFCProveedor_back.frx":28C2
      ImageCount      =   1
      ImagePicture(1) =   "frmAdminComprasListaFCProveedor_back.frx":2982
      PrinterProperties=   "frmAdminComprasListaFCProveedor_back.frx":2C9C
   End
