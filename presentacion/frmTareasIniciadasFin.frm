...
Begin VB.Form frmTareasIniciadasFin 
   ...
   ClientTop       =   435
   ClientWidth     =   14955
   Icon            =   "frmTareasIniciadasFin.frx":0000
   LinkMode        =   1  'Source
   LinkTopic       =   "df"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin GridEX20.GridEX gridProcesos 
      ...
      IntProp7        =   0
      ColumnsCount    =   3
      Column(1)       =   "frmTareasIniciadasFin.frx":000C
      Column(2)       =   "frmTareasIniciadasFin.frx":0138
      Column(3)       =   "frmTareasIniciadasFin.frx":022C
      FormatStylesCount=   6
      FormatStyle(1)  =   "frmTareasIniciadasFin.frx":0320
      FormatStyle(2)  =   "frmTareasIniciadasFin.frx":0458
      FormatStyle(3)  =   "frmTareasIniciadasFin.frx":0508
      FormatStyle(4)  =   "frmTareasIniciadasFin.frx":05BC
      FormatStyle(5)  =   "frmTareasIniciadasFin.frx":0694
      FormatStyle(6)  =   "frmTareasIniciadasFin.frx":074C
      ImageCount      =   0
      PrinterProperties=   "frmTareasIniciadasFin.frx":082C
   End
   ...
   Begin XtremeSuiteControls.PushButton btnIniciarTarea 
      ...
      _ExtentY        =   741
      _StockProps     =   79
      Caption         =   "Finalizar Tarea Seleccionada"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmTareasIniciadasFin"
...
Private tareasEnProgreso As Collection
...
Private Sub btnIniciarTarea_GotFocus()
    EnfocarTextBox
End Sub
...
Private Sub GetTareasEnProgreso()
    ...
    If tareasEnProgreso.count > 0 Then
        ShowMessage "Elija una tarea para finalizar"

        Me.gridProcesos.ItemCount = tareasEnProgreso.count
        Me.gridProcesos.row = -1
        Set proceso = Nothing
    Else
        ShowMessage "No tiene tareas sin finalizar"
    End If
...
Private Sub gridProcesos_GotFocus()
    EnfocarTextBox
End Sub
